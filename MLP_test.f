	...
	parameter(n1=100, n2=200, n3=100)	! values cannot exceed hgs
	...
	! WEIGHTS AND SUMS FOR THE HIDDEN LAYERS
...
!	nnh(3)=n3	
	...
	do i = 0, ntest-1
		do j = 1, 784
			...
			test(i+1, j) = dble(ichar(n))/2.55d2	! divide by 255 to normalize
								! to [0,1]
		enddo
	enddo
	close(1)
